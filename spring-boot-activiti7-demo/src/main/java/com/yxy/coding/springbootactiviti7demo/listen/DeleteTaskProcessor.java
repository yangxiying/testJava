...
@Component
@Transactional
public class DeleteTaskProcessor implements TaskListener {
    ...
    public void notify(DelegateTask delegateTask) {
        ...
        System.out.println("DeleteTaskProcessor::::::tmpval==="+delegateTask.getVariable("tmpval"));
        System.out.println("DeleteTaskProcessor::::::tmpvald==="+delegateTask.getVariable("tmpvald"));
