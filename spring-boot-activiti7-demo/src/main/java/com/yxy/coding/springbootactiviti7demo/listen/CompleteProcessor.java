...
@Component
@Transactional
public class CompleteProcessor implements TaskListener {
    ...
    public void notify(DelegateTask delegateTask) {
        ...
        System.out.println("CompleteProcessor::::::tmpval==="+delegateTask.getVariable("tmpval"));
        System.out.println("CompleteProcessor::::::tmpvald==="+delegateTask.getVariable("tmpvald"));
