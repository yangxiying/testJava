...
@Component
@Transactional
public class AssignmentProcessor implements TaskListener {
    ...
    public void notify(DelegateTask delegateTask) {
        ...
        System.out.println("AssignmentProcessor::::::tmpval=="+delegateTask.getVariable("tmpval"));
        System.out.println("AssignmentProcessor::::::tmpvald=="+delegateTask.getVariable("tmpvald"));
